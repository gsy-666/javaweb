      ...
      <div class="characters-container">
        <div class="characters">
          ...
          >
            ...
            <svg class="hard-hat" style="width: 190px; left: 0px; top: -48px;" viewBox="0 0 120 70" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <!-- Worker Safety Helmet (Yellow) -->
            <svg class="hard-hat" style="width: 150px; left: -15px; top: -46px;" viewBox="0 0 120 70" xmlns="http://www.w3.org/2000/svg">
              <path d="M 30 50 C 30 10, 90 10, 90 50 Z" fill="#FBBF24" />
              <rect x="54" y="12" width="12" height="38" rx="5" fill="#F59E0B" />
              <path d="M 15 50 Q 60 55 105 50" fill="none" stroke="#D97706" stroke-width="12" stroke-linecap="round" transform="translate(0, 3)" opacity="0.4" />
              <path d="M 15 50 Q 60 55 105 50" fill="none" stroke="#FBBF24" stroke-width="12" stroke-linecap="round" />
          ...
          >
            ...
            <svg class="hard-hat" style="width: 210px; left: 10px; top: -44px; transform: rotate(-5deg);" viewBox="0 0 120 70" xmlns="http://www.w3.org/2000/svg">
              <path d="M 30 50 C 30 10, 90 10, 90 50 Z" fill="#FBBF24" />
              <rect x="54" y="12" width="12" height="38" rx="5" fill="#F59E0B" />
              <path d="M 15 50 Q 60 55 105 50" fill="none" stroke="#D97706" stroke-width="12" stroke-linecap="round" transform="translate(0, 3)" opacity="0.4" />
              <path d="M 15 50 Q 60 55 105 50" fill="none" stroke="#FBBF24" stroke-width="12" stroke-linecap="round" />
    ...
    <div class="login-panel">
      <div class="login-box">
        ...
        <div class="header">
          ...
          <p class="subtitle">请登录以进入系统体验服务</p>
        </div>
        ...
        <form class="login-form" @submit.prevent="onSubmit">
          ...
          <div class="options">
            <label class="remember">
              <input type="checkbox" v-model="form.remember" style="accent-color: #09090b; width: 16px; height: 16px; cursor: pointer;" />
              <span>记住我</span>
            </label>
...
.hero-panel::before {
  ...
  background-position: center 100%; background-size: cover; transform: scale(1.3) translateY(-12%);
  opacity: 0.55;
